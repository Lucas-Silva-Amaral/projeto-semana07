...
btnMobile.addEventListener("click", ()=>{
    ...
    if (nav.classList.contains("active")) btnMobile.innerHTML = `<svg class="close" width="18" height="14" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    if (nav.classList.contains("active")) menuMobile.classList.add("active");
